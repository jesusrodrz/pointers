...
var config = {
    map: {
        '*': {
            filters_results: 'Entrepids_Ambientes/js/filters',
            perfilamiento: 'Entrepids_Ambientes/js/perfilamiento',
            inspiracion: 'Entrepids_Ambientes/js/inspiracion',
            icons: 'Entrepids_Ambientes/js/icons',
            validations: 'Entrepids_Ambientes/js/validation',
            customCatalogAddToCart: "Entrepids_Ambientes/js/productos",
            detailCatalogAddToCart: "Entrepids_Ambientes/js/detalle"
        }
    }
};
...
var config = {
    map: {
        '*': {
            estilo: 'Entrepids_Perfilamiento/js/estilo',
            inspiracion: 'Entrepids_Perfilamiento/js/inspiracion'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            'Magento_Customer/js/model/customer/address': 'Entrepids_ShippingAddressMap/js/model/customer/address',
            'Magento_Checkout/js/view/shipping-address/address-renderer/default': 'Entrepids_ShippingAddressMap/js/view/shipping-address/address-renderer/default',
            'Entrepids_ShippingAddressMap/fullCalendar': 'Entrepids_ShippingAddressMap/js/calendar/lib/fullcalendar.min',
            'Entrepids_ShippingAddressMap/touch': 'Entrepids_ShippingAddressMap/js/calendar/lib/jquery.ui.touch-punch.min',
            'Magento_Ui/js/form/element/post-code': 'Entrepids_ShippingAddressMap/js/form/element/post-code'
        }
    },
    config:{
        mixins: {
            'Magento_Checkout/js/action/set-shipping-information': {
                'Entrepids_ShippingAddressMap/js/action/set-shipping-coordenates-mixin': true
            },
            'Magento_Checkout/js/action/place-order':{
                'Entrepids_ShippingAddressMap/js/action/set-billing-coordenates-mixin': true
            } 
        }
    }
};
...
var config = {
    map: {
        '*': {
            tracker: 'Entrepids_Tracker/js/tracker'            
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            "Magento_Checkout/js/proceed-to-checkout": "Entrepids_Warranty/js/proceed-to-checkout"
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            categoryPageLabel: 'Entrepids_Label/js/categoryPageLabel'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
           'Magento_Swatches/js/swatch-renderer':'Entrepids_Saleunit/js/swatch-renderer'     
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            ...
            checkoutData:           'Magento_Checkout/js/checkout-data',
            proceedToCheckout:      'Magento_Checkout/js/proceed-to-checkout',
            converter:              'Magento_Checkout/js/cart/item/converter',
        }
    }
};
